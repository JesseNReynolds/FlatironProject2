...
Message.create(sender_id: 1, recipient_id: 2, created_at: 1605741912, content: "Some text", read: false)
Message.create(sender_id: 1, recipient_id: 2, created_at: 1605742012, content: "Some different text", read: false)
Message.create(sender_id: 2, recipient_id: 1, created_at: 1605742030, content: "Some text in response", read: false)